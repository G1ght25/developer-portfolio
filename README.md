...
## Интерактивная витрина проектов

![Интерактивное портфолио проектов](assets/screenshots/projects_mockups.png)

Веб-версия с интерактивными мокапами устройств и запуском игр:  
...
#### Главный экран веб-сервиса:
![PandaBar Desktop UI](assets/screenshots/pandabar_desktop_hero.png)

#### Каталог блюд, умная фильтрация и состав:
![PandaBar Catalog & Menu](assets/screenshots/pandabar_catalog_view.png)
...
|-- assets/
|   |-- screenshots/           # Реальные скриншоты интерфейсов сайта и игр
...
- **Telegram (прямой контакт):** [@g1ghtik](https://t.me/g1ghtik) — быстрый ответ в течение 10–15 минут
- **GitHub:** [https://github.com/G1ght25](https://github.com/G1ght25)
- **Специализация:** Full-Stack разработка (React 19 / Node.js / Python aiogram 3.x / KDS-системы)
- **Готовность к сотрудничеству:** Открыт для коммерческих заказов и продуктовой разработки под ключ.