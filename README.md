...
```text
developer-portfolio/
|-- index.html                 # Интерактивное веб-портфолио и резюме (поддержка GitHub Pages)
|-- style.css                  # Стили интерфейса (Obsidian Slate темная тема)
|-- app.js                     # Клиентская логика веб-витрины
|-- assets/
|   `-- 3d/
...
- **Витрина для клиентов:** умный каталог блюд с разделением на сеты, роллы и напитки; высокодетализированные студийные фотографии; динамический расчет бесплатной доставки (порог 1000 рублей); интерактивный выбор соусов и приборов; звуковое сопровождение оформления заказа (ASMR).
...
- **Панель управляющего и Администратора:** финансовая аналитика, учет складских остатков, управление мастер-PIN кодами и ролями сотрудников.
