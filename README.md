...
Открытый репозиторий портфолио проектов и резюме Full-Stack разработчика. В репозитории собраны готовые коммерческие решения, сложные веб-платформы, асинхронные боты и интерактивные приложения с интерактивной визуализацией в браузере.

---

## Интерактивное веб-портфолио (GitHub Pages)

Веб-версия портфолио доступна по адресу:  
**https://g1ght25.github.io/developer-portfolio/**

В веб-версию интегрированы интерактивные мокапы устройств:
- **MacBook Mockup (PandaBar):** кликабельное переключение между витриной покупателя, экраном повара кухни (KDS), кассовым термочеком 1С и экраном курьера.
- **iPhone Mockup (Telegram Bot):** симулятор Telegram с рабочими кнопками (Доставка еды, Онлайн-запись, Расчет сметы, Админ-панель).
- **Radar Terminal (Echo Sonar):** анимированный радар с возможностью запустить готовую HTML5-игру прямо внутри страницы портфолио.
...
|-- assets/
|   `-- 3d/
|       `-- crystal.obj        # 3D-модель (Wavefront OBJ)
